...
function showAddedBooks(addedBooks) {
    for (const book of addedBooks) {
        ...
        const addNoteBtn = cardDiv.firstElementChild.children[1].lastElementChild.firstElementChild;
...
function removeCard(e) {
    ...
    // confirm removal
    const removeConfirm = confirm(`Are you sure you want to remove ${title} from your Booket List?`);
    if (!removeConfirm) {
        return;
    }
