<<<<<<< HEAD
//Create function to retrieve saved books from database and store them in a var

//When books are pulled, populate them into cards and append them to the container.

//Add event listener to the delete button. When clicked, delete from collection
=======
...
function showAddedBooks(addedBooks) {
    for (const book of addedBooks) {
        ...
        const editBtn = cardDiv.firstElementChild.children[1].lastElementChild.firstElementChild;
        editBtn.addEventListener("click", editCard);

        const removeBtn = cardDiv.firstElementChild.children[1].lastElementChild.lastElementChild;
